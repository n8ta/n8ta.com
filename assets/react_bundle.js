...
(function () {
	...
	*/
	...
	function half_spaces(str) {
	  ...
	  const substr = str.substring(count, str.length);
	  new_str += substr;
	  return new_str;
	}
	...
	var Two = (({
	  ...
	  let shortened_code = split.map(half_spaces).join("\n");
	  return /*#__PURE__*/React.createElement("div", {
	    className: "two_col"
	  }, /*#__PURE__*/React.createElement("div", null, children), /*#__PURE__*/React.createElement("pre", null, /*#__PURE__*/React.createElement("code", {
	...
	const Parent$2 = () => {
	  ...
	  return /*#__PURE__*/React.createElement("div", {
	    className: "border"
	  }, /*#__PURE__*/React.createElement("h5", null, "Parent"), /*#__PURE__*/React.createElement("button", {
	    onClick: () => setCount(count + 1)
	  }, "Re-render me"), /*#__PURE__*/React.createElement("p", null, "Children are rendered with their parents. This becomes a problem fast as the tree grows."), /*#__PURE__*/React.createElement(Child, null));
	};
	...
	const Child = () => {
	  ...
	  return /*#__PURE__*/React.createElement("div", {
	    className: "border"
	  }, /*#__PURE__*/React.createElement("h5", null, "Child"), /*#__PURE__*/React.createElement("p", null, "I am the child"), /*#__PURE__*/React.createElement("button", {
	    onClick: () => setCount(count + 1)
	  }, "Re-render me"));
	};
	...
	class Counter extends React.Component {
	  ...
	  render() {
	    return /*#__PURE__*/React.createElement("div", {
	      className: "border"
	    }, /*#__PURE__*/React.createElement("h5", null, "Number Form"), /*#__PURE__*/React.createElement("input", {
	      placeholder: 10,
	      type: "number",
	      onChange: e => this.setState({
	        pendingNumber: e.target.valueAsNumber
	      })
	    }), /*#__PURE__*/React.createElement("button", {
	      onClick: e => this.setState({
	        number: this.state.pendingNumber
	      })
	    }, "Set number"), /*#__PURE__*/React.createElement(DisplayNumber, {
	...
	class DisplayNumber extends React.Component {
	  ...
	  render() {
	    return /*#__PURE__*/React.createElement("div", {
	      className: "border"
	    }, /*#__PURE__*/React.createElement("h5", null, "Display Number"), /*#__PURE__*/React.createElement("p", null, "The number is ", this.props.number));
	  }
	...
	class Counter2 extends React.Component {
	  ...
	  render() {
	    return /*#__PURE__*/React.createElement("div", {
	      className: "border"
	    }, /*#__PURE__*/React.createElement("h5", null, "Number Form"), /*#__PURE__*/React.createElement(DisplayNumber2, {
	      number: this.state.count
	    }), /*#__PURE__*/React.createElement("input", {
	      placeholder: 10,
	      type: "number",
	      onChange: e => this.setState({
	        pendingCount: e.target.valueAsNumber
	      })
	    }), /*#__PURE__*/React.createElement("button", {
	      onClick: e => this.setState({
	...
	const Parent2$2 = () => {
	  ...
	  }, "shouldComponentUpdate")), /*#__PURE__*/React.createElement(Two, {
	    code: counter2Code
	  }, /*#__PURE__*/React.createElement(Counter2, null)), /*#__PURE__*/React.createElement("p", null, "Now we can can render only if our props actually changed."), /*#__PURE__*/React.createElement("p", null, "Sadly this doesn't scale well... "), /*#__PURE__*/React.createElement("p", null, "What about large components with lots of props? Do we just keep adding ", /*#__PURE__*/React.createElement("code", null, "&&"), "'s to our shouldComponentUpdate"), /*#__PURE__*/React.createElement("p", null, "Some of our entities have 30+ fields... This won't work."));
	};

	const num_code = "const Number = () => {\n" + "    const [num, setNum] = useState(0);\n" + "    const [pendingNum, setPendingNum] = useState(0);\n" + "    return (\n" + "        <div className={\"border\"}>\n" + "            <h5>Number Form</h5>\n" + "            <DisplayNum num={num}/>\n" + "            <input placeholder={10} type={\"number\"} onChange={e => setPendingNum(e.target.valueAsNumber)}/>\n" + "            <button onClick={(e) => setNum(pendingNum)}>Set number</button>\n" + "        </div>)\n" + "}\n" + "const DisplayNum = ({num}) => {\n" + "    return <div className={\"border\"}><h5>Display Num</h5><p>The number is {num}</p></div>\n" + "}";
	const num_2_code = "const DisplayNum2 = React.memo(({num}) => {\n" + "    return <div className={\"border\"}><h5>Display Number</h5><p>The number is {num}</p></div>;\n" + "})";

	const Number$1 = () => {
	  const [num, setNum] = react.exports.useState(0);
	  const [pendingNum, setPendingNum] = react.exports.useState(0);
	  return /*#__PURE__*/React.createElement("div", {
	    className: "border"
	  }, /*#__PURE__*/React.createElement("h5", null, "Number Form"), /*#__PURE__*/React.createElement(DisplayNum, {
	    num: num
	  }), /*#__PURE__*/React.createElement("input", {
	    placeholder: 10,
	    type: "number",
	    onChange: e => setPendingNum(e.target.valueAsNumber)
	  }), /*#__PURE__*/React.createElement("button", {
	    onClick: e => setNum(pendingNum)
	  }, "Set number"));
	};
	...
	const DisplayNum = ({
	  ...
	  return /*#__PURE__*/React.createElement("div", {
	    className: "border"
	  }, /*#__PURE__*/React.createElement("h5", null, "Display Num"), /*#__PURE__*/React.createElement("p", null, "The number is ", num));
	};
	...
	const Number2 = () => {
	  ...
	  return /*#__PURE__*/React.createElement("div", {
	    className: "border"
	  }, /*#__PURE__*/React.createElement("h5", null, "Number Form"), /*#__PURE__*/React.createElement(DisplayNum2, {
	    num: num
	  }), /*#__PURE__*/React.createElement("input", {
	    placeholder: 10,
	    type: "number",
	...
	const DisplayNum2 = /*#__PURE__*/React.memo(({
	  num
	}) => {
	  return /*#__PURE__*/React.createElement("div", {
	    className: "border"
	  }, /*#__PURE__*/React.createElement("h5", null, "Display Number"), /*#__PURE__*/React.createElement("p", null, "The number is ", num));
	});
	var Functional = (() => {
	  return /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("p", null, "If we make component that are a function of their props. We can compare their old and new props and only render if they change"), /*#__PURE__*/React.createElement("p", null, "So how about a functional form like we did before? Obviously we still need state somewhere to store the number but instead of using ", /*#__PURE__*/React.createElement("code", null, "this.state"), " we will use ", /*#__PURE__*/React.createElement("code", null, "useState")), /*#__PURE__*/React.createElement(Two, {
	    code: num_code
	  }, /*#__PURE__*/React.createElement(Number$1, null)), /*#__PURE__*/React.createElement("p", null, "This has the same problem. But with one small change we can get all the benefits of ", /*#__PURE__*/React.createElement("code", null, "shouldComponentUpdate")), /*#__PURE__*/React.createElement("p", null, "Simply wrap ", /*#__PURE__*/React.createElement("code", null, "DisplayNumber"), " in ", /*#__PURE__*/React.createElement("code", null, "React.memo")), /*#__PURE__*/React.createElement(Two, {
	    code: num_2_code
	  }, /*#__PURE__*/React.createElement(Number2, null)), /*#__PURE__*/React.createElement("p", null, /*#__PURE__*/React.createElement("code", null, "React.memo"), " essentially writes that long ugly prop1 != newProp1 for us."));
	});

	const code4 = "function get_closure() {\n" + "  return () => {};\n" + "}   \n" + "alert(get_closure() === get_closure());";
	const code2 = "alert({} === {})";
	const code3 = "const closure = () => {};\n" + "alert(closure === closure);";
	const code5 = "function gen() {\n" + "    return  \"t\" + \"e\" + \"s\" + \"t\";\n" + "}\n" + "alert(gen() == gen())";
	...
	function spread() {
	  ...
	  return [a === new_a, a.outer === new_a.outer];
	}

	const code7 = "function spread() {\n" + "    const a = {outer: {innerKey: 2}};\n" + "    const b = {someNewKey: 'str'}\n" + "    const new_a = {a, ...b}\n" + "    return [a === new_a, a.outer === new_a.outer]\n" + "}";
	...
	const Runnable = ({
	  ...
	  onClick: run
	}, "Run")), /*#__PURE__*/React.createElement("pre", null, /*#__PURE__*/React.createElement("code", {
	...
	const Questions = ({
	  ...
	  return /*#__PURE__*/React.createElement("div", null, qs[index % qs.length], /*#__PURE__*/React.createElement("button", {
	    ...
	    onClick: () => setIndex(oldIdx => oldIdx + 1)
	  }, "Next"));
	};

	const closure = get_closure();

	const Gotchas = () => {
	  return /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("h4", null, "Equality in Javascript"), /*#__PURE__*/React.createElement("p", null, "What do we think true or false? "), /*#__PURE__*/React.createElement(Questions, {
	    qs: [/*#__PURE__*/React.createElement(Runnable, {
	      run: () => alert(1 === 1),
	      code: "alert(1===1)"
	      ...
	      run: () => alert(get_closure() === get_closure()),
	      code: code4
	    }), /*#__PURE__*/React.createElement(Runnable, {
	      run: () => alert(closure === closure),
	      code: code3
	    }), /*#__PURE__*/React.createElement(Runnable, {
	      run: () => alert(gen() === gen()),
	      code: code5
	  ...
	  }), /*#__PURE__*/React.createElement("h4", null, "Details"), /*#__PURE__*/React.createElement("ol", null, /*#__PURE__*/React.createElement("li", null, "Objects ", " are compared by pointer"), /*#__PURE__*/React.createElement("li", null, "Strings are interned meaning that there is only one copy of every string in memory"), /*#__PURE__*/React.createElement("li", null, "Mutating an object does NOT change it's pointer"), /*#__PURE__*/React.createElement("li", null, "Spreading an object changes the root pointer and the overwritten/added keys/value but all objects keep the same identity")));
	};
	...
	const Pages = ({
	  ...
	  react.exports.useEffect(() => {
	    try {
	      const got = window.localStorage.getItem("pages-idx");
	      let idx = JSON.parse(got);
	...
	const Parent$1 = () => {
	  ...
	  return /*#__PURE__*/React.createElement("div", {
	    className: "border"
	  }, /*#__PURE__*/React.createElement("h5", null, "Registration Form"), /*#__PURE__*/React.createElement("label", null, "Username"), /*#__PURE__*/React.createElement("br", null), /*#__PURE__*/React.createElement("input", {
	    onChange: e => setUsername(e.target.value),
	    type: "username"
	    ...
	    type: "password"
	  }), /*#__PURE__*/React.createElement("br", null), /*#__PURE__*/React.createElement(Terms, {
	...
	const Terms = ({
	  ...
	  className: "border"
	}, /*#__PURE__*/React.createElement("label", null, "Agree to terms?"), /*#__PURE__*/React.createElement("input", {
	  type: 'checkbox',
	  onClick: () => agree()
	}));
	...
	const Parent2$1 = () => {
	  ...
	  return /*#__PURE__*/React.createElement("div", {
	    ...
	    type: "password"
	  }), /*#__PURE__*/React.createElement("br", null), /*#__PURE__*/React.createElement(TermsMemo, {
	    agree: () => setAgreed(true)
	  }));
	};
	...
	const Parent3 = () => {
	  const [agreed, setAgreed] = react.exports.useState(false);
	  const [username, setUsername] = react.exports.useState(null);
	  const agree = react.exports.useCallback(() => setAgreed(true), []);
	  return /*#__PURE__*/React.createElement("div", {
	    className: "border"
	  }, /*#__PURE__*/React.createElement("h5", null, "Registration Form"), /*#__PURE__*/React.createElement("label", null, "Username"), /*#__PURE__*/React.createElement("br", null), /*#__PURE__*/React.createElement("input", {
	    onChange: e => setUsername(e.target.value),
	...
	const TermsMemo = /*#__PURE__*/React.memo(({
	  agree
	}) => /*#__PURE__*/React.createElement("div", {
	  className: "border"
	}, /*#__PURE__*/React.createElement("label", null, "Agree to terms?"), /*#__PURE__*/React.createElement("input", {
	...
	var songs = [{
	  ...
	  id: 1,
	  path: "/assets/mp3/newbegin.mp3",
	  name: "A new beginning"
	}, {
	  id: 2,
	  path: "/assets/mp3/higher.mp3",
	  name: "Going higher"
	}];
	...
	const usePlayer = (timeCb, songCompleteCb, field) => {
	  ...
	  const player = {
	    ...
	    play_song: song => {
	      ...
	      audio.loop = false;
	      audio.play();
	      storage.current = audio;
	    },
	    pause: () => {
	      storage.current.pause();
	    },
	    resume: () => {
	      storage.current.play();
	    },
	    paused: () => {
	      return storage.current.paused;
	    },
	    position: () => {
	      return {
	        current: storage.current.currentTime,
	        duration: storage.current.duration
	      };
	    },
	    scrub_to: time => {
	      storage.current.currentTime = time;
	    }
	  };
	  setInterval(() => {
	...
	const DeclarativePlayer = ({
	  ...
	  if (playing !== song) {
	    ...
	    imperative_player.play_song(song);
	    imperative_player.scrub_to(0.0);
	    setPlaying(song);
	  }

	  const domIsPaused = imperative_player.paused();

	  if (paused !== domIsPaused) {
	    console.info("declarative player pauses or resumes", "dom is paused", domIsPaused, "react paused", paused);

	    if (paused) {
	      console.info("decl pauses");
	      imperative_player.pause();
	    } else {
	      console.info("decl resumes");
	      imperative_player.resume();
	    }
	  }

	  if (Math.abs(time - imperative_player.position().current) > 3) {
	    console.info("declarative player scrubs");
	    imperative_player.scrub_to(time);
	  }

	  return null;
	};

	var DeclarativePlayer$1 = /*#__PURE__*/React.memo(DeclarativePlayer);
	...
	ReactDOM.render( /*#__PURE__*/React.createElement(App, null), document.getElementById('react-app-root'));
